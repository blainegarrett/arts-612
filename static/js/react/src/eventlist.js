...
var TempUpcoming = React.createClass({
    ...
    getInitialState: function (){
        return {ed_filter: 'timed', 'col_name': 'OPENINGS & EVENTS', event_data: [], 'resource_url': '/static/upcoming.json'};
    },
    render: function () {
...
var TempEvents = React.createClass({
    mixins: [TempEventsListMixin],
    getInitialState: function (){
        return {ed_filter: 'reoccurring', 'col_name': 'NOW SHOWING', 'event_data': [], 'resource_url': '/static/now_showing.json'};
    },
